...
import tim.android.util.NetworkUtil;
...
public class FeedItemAdapter extends RecyclerView.Adapter<FeedItemAdapter.ViewHolder> {
    ...
    private final List<Article> feedItems;
    ...
    public void refreshData(@NonNull List<Article> feedItems) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(@NonNull View v) {
                if (!NetworkUtil.isNetworkAvailable(v.getContext())) {
                    Snackbar.make(v, v.getContext().getString(R.string.no_connection_message), Snackbar.LENGTH_SHORT)
                            .show();
                    return;
                }
